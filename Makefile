...
lint: ## check style with flake8
	poetry run flake8 offeneregister tests
...
coverage: ## check code coverage quickly with the default Python
	poetry run coverage run --source offeneregister -m pytest
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/offeneregister.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ offeneregister
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
